...
`examples/` 目录包含 9 组真实文献编译案例，涵盖论文、专利、TDS 三种类型。详细说明请参见 [references/examples.md](references/examples.md)。

Schema 验证与常见问题修复指南请参见 [references/schema_validation.md](references/schema_validation.md)。
